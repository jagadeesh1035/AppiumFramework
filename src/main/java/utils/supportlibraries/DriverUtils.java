...
public class DriverUtils {
	...
	public DriverUtils(ScriptHelper scriptHelper) {
	...
	public void waitUntilElementIsVisible(By by) {
		...
		logger.info("Waiting for the visibility of the element" + by.toString());
	}
	...
	public void waitUntilElementIsDisabled(By by) {
		getWebDriverWait().until(ExpectedConditions.not(ExpectedConditions.elementToBeClickable(by)));
	}

	/*
	 * Method to verify if objects exists or not
	 */
	...
	/*
	 * Methods to click on an element
	 */
	...
	public boolean waitForVisibility(By targetElement) {
		try {
			...
			logger.log(Status.DEBUG, "Element is not visible: " + targetElement);
			throw e;
	...
	public boolean waitForInvisibility(By targetElement) {
		try {
			...
			logger.log(Status.DEBUG, "Element is still visible: " + targetElement);
			System.out.println("Element is still visible: " + targetElement);
			logger.log(Status.FATAL, e.getMessage());
			throw e;
	 ...
	 * @return
	 */
	public ConnectionState getNetworkConnection() {
	...
	public void setNetworkConnection(boolean airplaneMode, boolean wifi, boolean data) {
		...
		logger.log(Status.INFO, "Your current connection settings are :" + ((AndroidDriver) driver).getConnection());
	}
	...
	public void longPress(By locator) {
		try {
			...
			logger.error(this.getClass().getName() + "Element not found" + locator);
			throw e;
		}
